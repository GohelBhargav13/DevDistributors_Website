...
include '../frontend/Admin/conn.php';
include '../Comman_pages/navbar.php';

$sql = "SELECT * FROM distributors WHERE approve_status = 'accepted' ";
$count = 0;
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <thead>
                                                <H3 class="text-dark" align="center">All User's Recored</H3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        <tr style="border-bottom: 2px solid black;">
                                                            ...
                                                            <td><?= htmlspecialchars($row['shop_add']) ?></td>
                                                            <td><?= htmlspecialchars($row['approve_status']) ?></td>
                                                            <td>
                                                                <form action="./approve_list.php" method="post">
                                                                    <input type="hidden" name="approve_id" value="<?= htmlspecialchars($row['d_id']); ?>">
                                                                    <button type="submit" class="btn btn-danger btn-sm px-4" name="btn2" style="margin-left: 20px;">
